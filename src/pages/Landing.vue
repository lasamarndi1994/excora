  ...
  <div class="landing-page">
    ...
    <v-app-bar color="transparent" flat class="px-md-16 px-4 pt-4 backdrop-blur" absolute>
      ...
      <div class="d-none d-md-flex">
        <v-btn variant="text" class="text-capitalize mx-1 font-weight-medium" type="button">Features</v-btn>
        <v-btn variant="text" class="text-capitalize mx-1 font-weight-medium" type="button">Solutions</v-btn>
      ...
      <v-container class="position-relative z-10">
        <v-row align="center" justify="space-between">
          <v-col cols="12" md="6" class="py-10">
            ...
            <h1 class="text-h3 text-md-h2 font-weight-black text-secondary mb-4 leading-tight">
              Move fast, <br>
            ...
            <div class="d-flex flex-wrap gap-4">
              ...
              <v-btn variant="outlined" color="secondary" size="x-large" rounded="lg"
                class="px-8 font-weight-bold bg-white">
                View Demo
              </v-btn>
            </div>
          ...
          <v-col cols="12" md="6" class="d-none d-md-flex justify-center position-relative perspective-container">
            ...
            <v-card width="100%" max-width="650"
              ...
              <div class="fill-height d-flex flex-column bg-white">
                <!-- Fake Header -->
                <div class="pa-3 border-b d-flex align-center bg-grey-lighten-5">
                ...
                <!-- Fake Body -->
                <div class="d-flex fill-height bg-grey-lighten-5 pa-4">
                  <!-- Sidebar -->
                  <div class="bg-white rounded-lg elevation-1 pa-3 mr-4" style="width: 60px;">
                  ...
                  <div class="flex-grow-1 d-flex gap-4 overflow-hidden">
                    <div class="bg-grey-lighten-4 rounded-lg flex-grow-1 pa-2">
                      <div class="text-caption font-weight-bold mb-2 ml-1 text-medium-emphasis">TO DO</div>
                      <div class="bg-white rounded pa-3 mb-2 elevation-1 border-s-4 border-primary">
                        <div class="bg-grey-lighten-2 rounded mb-2" style="width: 80%; height: 10px;"></div>
                        <div class="bg-grey-lighten-4 rounded" style="width: 40%; height: 8px;"></div>
                      </div>
                      <div class="bg-white rounded pa-3 mb-2 elevation-1">
                        <div class="bg-grey-lighten-2 rounded mb-2" style="width: 90%; height: 10px;"></div>
                        <div class="bg-grey-lighten-4 rounded" style="width: 50%; height: 8px;"></div>
                      </div>
                    </div>
                    <div class="bg-grey-lighten-4 rounded-lg flex-grow-1 pa-2">
                      <div class="text-caption font-weight-bold mb-2 ml-1 text-medium-emphasis">IN PROGRESS</div>
                      <div class="bg-white rounded pa-3 mb-2 elevation-1 border-s-4 border-warning">
                        <div class="bg-grey-lighten-2 rounded mb-2" style="width: 70%; height: 10px;"></div>
                        <div class="d-flex justify-space-between align-center mt-2">
                          <div class="bg-grey-lighten-4 rounded" style="width: 30%; height: 8px;"></div>
    ...
    <!-- Trusted By Section -->
    <div class="bg-grey-lighten-5 py-10 border-y">
      <v-container>
        <p class="text-center text-caption font-weight-bold text-medium-emphasis text-uppercase mb-8 tracking-wide">
          Trusted by modern teams worldwide</p>
        <v-row justify="center" align="center" class="opacity-60 grayscale pb-4">
          <v-col cols="6" sm="4" md="2" class="d-flex justify-center">
            <h3 class="text-h6 font-weight-black text-grey-darken-1">ACME Co.</h3>
          </v-col>
          <v-col cols="6" sm="4" md="2" class="d-flex justify-center">
            <h3 class="text-h6 font-weight-black text-grey-darken-1">GlobalBank</h3>
          </v-col>
          <v-col cols="6" sm="4" md="2" class="d-flex justify-center">
            <h3 class="text-h6 font-weight-black text-grey-darken-1">DevCorp</h3>
          </v-col>
          <v-col cols="6" sm="4" md="2" class="d-flex justify-center">
            <h3 class="text-h6 font-weight-black text-grey-darken-1">NextGen</h3>
          </v-col>
          <v-col cols="6" sm="4" md="2" class="d-flex justify-center">
            <h3 class="text-h6 font-weight-black text-grey-darken-1">Starlight</h3>
          </v-col>
        </v-row>
      </v-container>
    </div>
    ...
    <v-container class="py-16">
      <div class="text-center mb-16">
        ...
        <p class="text-subtitle-1 text-medium-emphasis mx-auto" style="max-width: 600px;">Stop juggling multiple tools.
          MyTask brings your entire product lifecycle into one unified platform.</p>
      </div>
      ...
      <v-container>
        <v-row align="center" class="mb-16">
          <v-col cols="12" md="6" class="pr-md-16">
            <h2 class="text-h3 text-md-h2 font-weight-black text-secondary mb-4 leading-tight">
              Focus on code, <br>
              <span class="text-gradient">not chaos.</span>
            </h2>
            <p class="text-body-1 text-grey-darken-3 mb-6">
              Developers love MyTask because it stays out of their way. GitHub & GitLab integrations mean you can update
              status directly from your commit messages.
            </p>
            <div class="d-flex flex-column gap-3">
              <div class="d-flex align-center">
                <v-icon color="primary" class="mr-3">mdi-check</v-icon>
                <span class="font-weight-medium text-black">Two-way Git synchronization</span>
              </div>
              <div class="d-flex align-center">
                <v-icon color="primary" class="mr-3">mdi-check</v-icon>
                <span class="font-weight-medium text-black">Automated CI/CD workflows</span>
              </div>
              <div class="d-flex align-center">
                <v-icon color="primary" class="mr-3">mdi-check</v-icon>
                <span class="font-weight-medium text-black">Smart commit linking</span>
              </div>
            </div>
          </v-col>
          <v-col cols="12" md="6">
      ...
      <v-card color="primary" class="rounded-xl overflow-hidden position-relative pa-16 elevation-10" theme="dark">
        ...
        <div class="position-relative z-10">
          ...
          <p class="text-h6 text-white mb-8 opacity-90 mx-auto" style="max-width: 600px;">
            Join thousands of high-performing teams using MyTask today.
          </p>
    ...
    <!-- Footer -->
    <v-footer class="bg-white text-medium-emphasis py-12 border-t">
      <v-container>
        <v-row>
          <v-col cols="12" md="4" class="mb-8 mb-md-0">
            <div class="d-flex align-center mb-4">
              ...
              <span class="text-h6 font-weight-bold text-primary">MyTask</span>
            </div>
          ...
          <v-col cols="6" md="2">
            <h4 class="font-weight-bold mb-4 text-black">Product</h4>
            <div class="d-flex flex-column gap-2 text-body-2">
              ...
              <a href="#" class="text-decoration-none text-medium-emphasis hover-primary">Pricing</a>
              <a href="#" class="text-decoration-none text-medium-emphasis hover-primary">Enterprise</a>
            </div>
          </v-col>

          <v-col cols="6" md="2">
            <h4 class="font-weight-bold mb-4 text-black">Resources</h4>
            <div class="d-flex flex-column gap-2 text-body-2">
          ...
          <v-col cols="12" md="4">
            <h4 class="font-weight-bold mb-4 text-black">Stay up to date</h4>
            <v-text-field density="comfortable" bg-color="grey-lighten-4" hide-details placeholder="Enter your email"
